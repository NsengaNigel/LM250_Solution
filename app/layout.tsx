        ...
        <footer className="border-t border-slate-800 bg-slate-950 py-12">
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center gap-6 sm:flex-row sm:justify-between">
              {/* Brand */}
              <div>
                <p className="text-sm font-semibold text-white">LM250 Solutions</p>
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  ...
                  title="Email us"
                  className="flex h-9 w-9 items-center justify-center rounded-lg border border-slate-700 bg-slate-900 text-slate-400 transition-colors hover:border-gold-500/40 hover:text-gold-400"
                >
